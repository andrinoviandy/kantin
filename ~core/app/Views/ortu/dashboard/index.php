        ...
        <div class="page page-home page-with-subnavbar">
            <div class="toolbar tabbar tabbar-labels toolbar-bottom">
                <div class="toolbar-inner">
                    ...
                    <a href="#" class="tab-link" onclick="location.href='<?= base_url('ortu/deposit') ?>'">
                    ...
                    <div id="tab-1" class="tab <?= (isset($_SESSION['aktif'])) ? '' : 'tab-active' ?> page-content">
                        ...
                        <div class="menus">
                            <div class="container">
                                <div class="row">
                                    <div class="col">
                                        <a href="" onclick="location.href='<?= base_url('ortu/history') ?>'">
                                    ...
                                    <div class="col">
                                        <a href="" onclick="location.href='<?= base_url('ortu/history/transaksi') ?>'">
                                            <div class="background-white text-center border-radius padding-box box-shadow">
                                                <span class="icon-big icon-color-red"><i class="fa fa-redo"></i></span>
                                                <h6 class="font-weight-500">Transaksi Siswa</h6>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a href="" onclick="location.href='<?= base_url('ortu/profile') ?>'">
                                            <div class="background-white text-center border-radius padding-box box-shadow">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <a href="" onclick="location.href='<?= base_url('ortu/profile/password') ?>'">
                                            <div class="background-white text-center border-radius padding-box box-shadow">
                                    ...
                                    <div class="col">
                                        <a href="" onclick="location.href='<?= base_url('ortu/deposit') ?>'">
                                            <div class="background-white text-center border-radius padding-box box-shadow">
                                                <span class="icon-big icon-color-orange"><i class="fa fa-wallet"></i></span>
                                                <h6 class="font-weight-500">Deposit</h6>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col">
                        ...
                        <div class="deposit margin-top">
                            <div class="container">
                                <?php if (empty($deposit)) : ?>
                                    <form method="post" action="<?= base_url() ?>/ortu/dashboard/deposit">
                                ...
                                <?php else : ?>
                                    ...
                                    <div class="background-white border-radius box-shadow">
                                        <div class="padding-box">
                                            ...
                                            <form action="<?= base_url('ortu/dashboard/konfirmasi/' . $deposit->id) ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <button onclick="location.href='<?= base_url() ?>/ortu/dashboard/batal/<?= $deposit->id ?>'" class="buttons buttons-full margin-top-small box-shadow" style="background:red">Batalkan Deposit</button>
                                <?php endif ?>
                            </div>
                        </div>
                        <!-- end deposit -->
                    ...
                    <div id="tab-5" class="tab page-content">
                        ...
                        <div class="list-pages account-list">
                            ...
                            <div class="container">
                                <ul>
                                    <li>
                                        <a class="border-radius box-shadow" onclick="location.href='<?= base_url('ortu/history') ?>'">
                                    ...
                                    <li>
                                        <a class="border-radius box-shadow" onclick="location.href='<?= base_url('ortu/history/transaksi') ?>'">
                                            <span class="margin-right-small icon-small icon-color-red"><i class="fa fa-history"></i></span> Transaksi Siswa <span class="float-right"><i class="fa fa-chevron-right"></i></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="border-radius box-shadow" onclick="location.href='<?= base_url('ortu/profile') ?>'">
                                    ...
                                    <li>
                                        <a class="border-radius box-shadow" onclick="location.href='<?= base_url('ortu/profile/password') ?>'">
