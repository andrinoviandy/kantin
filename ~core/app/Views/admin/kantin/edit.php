                ...
                <form action="" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" value="<?= kode_kantin($kantin->kode) ?>" readonly>
                                <input type="hidden" name="kode" value="<?= $kantin->kode ?>">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="example-text-input" class="col-md-4 col-form-label">Nama Kantin <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="nama" value="<?= $kantin->nama ?>" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-8">
                                <select name="pemilik" class="form-select" required>
                                    ...
                                    <?php foreach ($pemilik as $o) : ?>
                                        <option value="<?= $o->id ?>" <?= ($kantin->pemilik == $o->id) ? 'selected' : '' ?>><?= $o->nama ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8">
                                <select name="petugas" class="form-select" required>
                                    ...
                                    <?php foreach ($petugas as $p) : ?>
                                        <option value="<?= $p->id ?>" <?= ($kantin->petugas == $p->id) ? 'selected' : '' ?>><?= $p->nama ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                        </div>
