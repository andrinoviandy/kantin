                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" name="kode" type="text" value="<?= $siswa->kode ?>" readonly>
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="nama" value="<?= $siswa->nama ?>" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="example-text-input" class="col-md-3 col-form-label">Kelas <span class="text-danger">*</span></label>
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="kelas" value="<?= $siswa->kelas ?>" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="whatsapp" value="<?= $siswa->whatsapp ?>">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="example-text-input" class="col-md-3 col-form-label">Foto Siswa</label>
                            <div class="col-md-9">
                                <img id="output" width="100" class="img-thumbnail" src="<?= base_url('assets/client/foto/' . $siswa->foto) ?>" />
