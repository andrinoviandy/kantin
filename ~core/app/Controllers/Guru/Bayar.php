...
class Bayar extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('guru/bayar/index', $data);
    }
    ...
    {
        $detail = $this->transaksi_detail_temp->select('transaksi_detail_temp.id, transaksi_detail_temp.id_barang, transaksi_detail_temp.harga, transaksi_detail_temp.jumlah, barang.nama as nama, barang.foto')->where('id_guru', session()->get('id'))->join('barang', 'barang.id=transaksi_detail_temp.id_barang')->findAll();

        $siswa = $this->guru->where('id', session()->get('id'))->first();
